...
export const TrustTicker: React.FC = () => {
  const items = [
    ...
    { label: '1.00% Daily Continuous Yield', icon: <MonetizationOnIcon sx={{ fontSize: 16, color: '#FFD700' }} /> },
    { label: '100-Day Principle Doubling Cycle', icon: <VerifiedIcon sx={{ fontSize: 16, color: '#a78bfa' }} /> },
